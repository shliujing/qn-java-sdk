...
public class FaultTolerantDataSender {
    ...
    public static void main(String[] args) {
        //设置需要操作的账号的AK和SK
        String ak = Config.PANDORA_ACCESS_KEY;
        String sk = Config.PANDORA_SECRET_KEY;
        ...
        // 注： me.lj.qiniu.pandora.sender.FaultTolerantDataSender 会将 LogCacheDir 目录里的文件根据 repoName 进行过滤，进行重试发送
