...
public class GenPhotoDetail {
    public static void main(String[] args) {
        ...
        String url201805tuanjian = "https://s.dandantuan.com/201805tuanjian/DSC_0048.JPG\n" +
                ...
                "https://s.dandantuan.com/201805tuanjian/DSC_0295.JPG\n" +
                ...
                "https://s.dandantuan.com/201805tuanjian/DSC_0492Trim.mp4\n" +
        ...
        if (len > 0) {
            ...
            for (int i = 0; i < len; i++) {
                ...
                String s3 = url + "\"";//url
                String s7 = url + "?imageView2/1/w/200/h/200\"/></a></div>";//url
