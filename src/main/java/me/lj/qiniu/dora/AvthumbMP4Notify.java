...
public class AvthumbMP4Notify {
    ...
    public static void main(String args[]) throws IOException {
        ...
        String key = "mp4/720p/2科目2-3号道讲解.mp4";
        //上传后的文件名
        String newKey = "qiniu/0128/test-2.mp4";

        //设置转码操作参数
        String fops = "avthumb/mp4/r/24/vcodec/libx264/ss/2/t/10";
        //设置转码的队列
