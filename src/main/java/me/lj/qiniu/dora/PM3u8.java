...
/**
 * pm3u8 https://developer.qiniu.com/dora/manual/1292/private-m3u8-pm3u8
 */
public class PM3u8 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        String key = "11.mp4";
        //上传后的文件名
        String newKey = "pm3u8/test265-2.mp4";
        ...
        String urlbase64 = UrlSafeBase64.encodeToString("imc-hd:" + newKey);
