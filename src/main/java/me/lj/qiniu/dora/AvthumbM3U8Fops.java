...
public class AvthumbM3U8Fops {
    ...
    public static void main(String[] args) throws QiniuException {
        ...
        String bucket = "imc-hd";
        String key = "第三方的十分.mp4";
        String newKey = "qiniu/third.m3u8";
        //设置转码操作参数
        String fops = "avthumb/m3u8/noDomain/1/segtime/15/vb/1m";
        //设置转码的队列
